...
import { Box, Button, Heading, Input, VStack, Text, Link, IconButton, HStack, Flex, Icon } from "@chakra-ui/react"
  ...
  return (
    <Box minH="100vh" display="flex" flexDirection={{ base: "column", md: "row" }} fontFamily="heading">
      ...
      <Box flex="1" bg="neutral.canvas" display="flex" alignItems="center" justifyContent="center" p={8} position="relative">
        ...
        >
          <RouterLink to="/">
            <Icon asChild size="sm"><ArrowLeft size={18} /></Icon>
            Home
          </RouterLink>
        </Link>
            ...
            <VStack gap={5} align="stretch">
              ...
              <Box>
                <Flex justify="space-between" align="center" ml={1} mb={2}>
                  ...
                  <Link asChild fontSize="xs" fontWeight="medium" color="brand.600" _hover={{ textDecoration: "underline" }}>
                    <RouterLink to="/verify-email?mode=forgot">{t('login.forgot_password')}</RouterLink>
                  </Link>
                </Flex>
                <Box position="relative">
                  <Box position="absolute" left="3" top="50%" transform="translateY(-50%)" color="neutral.subtext" zIndex="2">
